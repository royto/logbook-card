...
customElements.define('action-handler-logbook-card', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-logbook-card')) {
    return body.querySelector('action-handler-logbook-card') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-logbook-card');
